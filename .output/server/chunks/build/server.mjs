import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, toRef, isRef, defineAsyncComponent, mergeProps, getCurrentScope, computed, defineComponent, h, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
...
let _profileStateReal = null;
function ensureProfileState() {
  if (!_profileStateReal) {
    _profileStateReal = useState("current-user-profile", () => ({
      profile: null,
      loading: false,
      error: null,
      loadedUserId: null,
...
let _authStateReal = null;
function ensureAuthState() {
  if (!_authStateReal) {
    _authStateReal = useState("auth", () => ({
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CgjEG3iY.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BRlnaru7.mjs'));
